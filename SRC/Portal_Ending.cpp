...
int main()
{
	...
	PlaySound(TEXT("portal_sa.wav"), NULL, SND_ASYNC);
	...
	/*gotoxy(3, 1);
	log(75, 0, false, "Forms FORM-29827281-12:");
	gotoxy(3, 2);
	log(75, 0, false, "Test Assessment Report");
	PlaySound(TEXT("portal_sa.wav"), NULL, SND_ASYNC);
	gotoxy(3, 6);
	log(90, 0, false, "This was a triumph.");
	cursor(300, 4, 7);
	cursor(300, 4, 7);
	cursor(300, 4, 7);
	gotoxy(3, 7);
	log(85, 0, false, "I'm making a note here:");
	gotoxy(3, 8);
	log(125, 0, false, "HUGE SUCCESS.");
	cursor(300, 4, 9);
	cursor(300, 4, 9);
	cursor(300, 4, 9);
	cursor(300, 4, 9);
